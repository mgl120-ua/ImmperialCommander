...
public class FighterPreTest {
	...
	public final void testAddAttack() {
		fighter.addAttack(30);
		assertEquals (110, fighter.getAttack());
		fighter.addAttack(-800);
	...
	public final void testAddShield() {
		...
		assertEquals (-50, fighter.getShield());
	...
	public final void testSetPositionNull() {
		...
		assertEquals(c,fighter.getPosition());
	...
	public final void testToString2() {
		 ...
		 */
		final String sout = "(XWing 1 REBEL [5,3] {50,110,90})";
		Coordinate c = new Coordinate(5, 3);
		fighter.setPosition(c);	
		fighter.addAttack(30);
		fighter.addShield(10);
		fighter.addVelocity(-50);
		assertEquals(sout, fighter.toString());
		//fail("completa el test");
	}
	...
	public final void testFight4() {
		 ...
		 */
		Fighter enemy = new Fighter("TIEFighter", imperialShip);
		fighter.addAttack(70);
		fighter.addShield(70);
		fighter.addVelocity(70);
		assertEquals(1,fighter.fight(enemy));
		//fail("completa el test");
	}
