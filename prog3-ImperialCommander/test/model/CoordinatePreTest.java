...
public class CoordinatePreTest {
	...
	public void testGetter() {
		...
		assertEquals("x==10", 10, c1.getX());
		assertEquals("y==4", 4, c1.getY());
	...
	public void testAdd() {
		...
		Coordinate cadd1 = c1.add(c2.getX(),c2.getY());
		// comprobamos que se suma bien
		assertEquals("x==-72", -72, cadd1.getX());
		assertEquals("y==18", 18, cadd1.getY());
		
		// comprobamos que la coordenada que devuelve no es la misma sobre la que se invoca el método
        assertNotSame(c1,cadd1);
	...
	public void testAddAll() {
		...
		for (int i=0; i<DIM-2; i++) {	
		    ...
		    */
		   assertEquals("sumx y caux1 iguales",sumx, caux1.getX());
		   assertEquals("sumy y caux1 iguales",sumy, caux1.getY());
		   assertNotEquals("caux1=caux2",caux1, caux2);
	...
	public void testEqualsObject() {
		...
		assertFalse("false x/y distinto", c.equals(c1));
		assertTrue("true1", obj.equals(obj));
		assertTrue("true2", c.equals(c2));
